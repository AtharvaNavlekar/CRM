...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    reason: 'DialPulse CRM initialized with Apex Realty tenant and sample pipeline.',
    ip: '103.21.124.50'
  },
  {
    id: 'aud-2',
    tenantId: 'tenant-apex',
    occurredAt: subtractHours(1.5),
    ...
    reason: 'Changed Vikram Malhotra stage from New to Contacted.',
    ip: '103.21.124.52'
  },
  {
    id: 'aud-3',
    tenantId: 'tenant-apex',
    occurredAt: subtractHours(1),
    ...
    actorRole: 'telecaller',
    action: 'CALL_LOGGED',
    reason: 'Logged 3m 5s follow-up call with Rajesh K. Singhania.',
    ip: '103.21.124.88'
  },
  {
    id: 'aud-zen-1',
    tenantId: 'tenant-zenith',
    occurredAt: subtractHours(1.8),
    requestId: 'seed-req-4',
    eventType: 'CALL_LOGGED',
    outcome: 'SUCCESS',
    actorUserId: 'usr-zen-3',
    actorRole: 'telecaller',
    action: 'CALL_LOGGED',
    reason: 'Completed counseling session with Siddharth Varma for Cloud DevOps program.',
    ip: '103.21.124.99'
  }
];
